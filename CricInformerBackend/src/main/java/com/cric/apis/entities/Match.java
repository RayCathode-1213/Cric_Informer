...
public class Match {
	...
	public MatchSataus getStatus() {
		return status;
	}

	public void setStatus(MatchSataus status) {
		this.status = status;
	}
	...
	public void setMatchStatus() {
		if (textComplete.isBlank()) {
			this.status = MatchSataus.LIVE;
		} else {
			this.status = MatchSataus.COMPLETED;
		}
	}
